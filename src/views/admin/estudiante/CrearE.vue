            ...
            <form @submit.prevent="guardar" class="row g-3 pb-4">
                ...
                <div class="col-md-6 pb-3">
                    ...
                    <input type="text" v-model="celular" class="form-control" id="correo" placeholder="Celular" required
                        @blur="celularT = true">
                    <span v-if="celularT && !celular" class="text-danger small ">{{ mensajesError.celular }}</span><br>
...
export default {
    data() {
        return {
            ...
            celular: '',
            celularT: false,
            url: 'http://54.196.78.164:3000/api/estudiante',
            ...
            axios.post(this.url, {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "/admin/estudiante";
                    }
                });
