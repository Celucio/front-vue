        ...
        <div class="col-md-6 offset-md-3">
            <form @submit.prevent="guardar" class="row g-3 pb-4">
                ...
                <div class="col-md-6">
                    ...
                    <span v-if="validarFechaIActividad(fechaInicio) && fechaInicio" class="error text-danger small">No se permite fecha menor a la actual</span>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <button :disabled="validarFechaIActividad(fechaInicio)" type="submit" class="btn btn-success text-white w-50 rounded-5">Crear</button>
                </div>
                <div class="col-6">
